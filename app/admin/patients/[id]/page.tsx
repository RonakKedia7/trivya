          ...
          <div className="rounded-xl border border-border bg-card p-6">
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-foreground">{patient.dateOfBirth}</span>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-foreground">{patient.emergencyContact}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="rounded-xl border border-border bg-card">
            <div className="border-b border-border px-6 py-4">
              <h2 className="text-lg font-semibold text-foreground">Appointments ({patientAppointments.length})</h2>
            </div>
          ...
          <div className="rounded-xl border border-border bg-card">
            <div className="border-b border-border px-6 py-4">
              <h2 className="text-lg font-semibold text-foreground">Medical Records ({patientRecords.length})</h2>
            </div>
