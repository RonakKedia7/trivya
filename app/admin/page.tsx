    ...
    <div>
        ...
        <div className="rounded-xl border border-border bg-card p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-3xl font-bold text-foreground">{stats.totalDoctors}</p>
            </div>
          ...
          <Link href="/admin/doctors" className="mt-4 inline-flex cursor-pointer items-center text-sm text-primary hover:underline">
            View all doctors
        ...
        <div className="rounded-xl border border-border bg-card p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-3xl font-bold text-foreground">{stats.totalPatients}</p>
            </div>
          ...
          <Link href="/admin/patients" className="mt-4 inline-flex cursor-pointer items-center text-sm text-primary hover:underline">
            View all patients
            <svg className="ml-1 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
        ...
        <div className="rounded-xl border border-border bg-card p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-3xl font-bold text-foreground">{stats.todayAppointments}</p>
            </div>
          ...
          <Link href="/admin/appointments" className="mt-4 inline-flex cursor-pointer items-center text-sm text-primary hover:underline">
        ...
        <div className="rounded-xl border border-border bg-card p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-3xl font-bold text-foreground">{stats.pendingAppointments}</p>
            </div>
          ...
          <p className="mt-4 text-sm text-muted-foreground">{stats.completedAppointments} completed</p>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-border bg-card">
        <div className="flex items-center justify-between border-b border-border px-6 py-4">
          ...
          <Link href="/admin/appointments" className="cursor-pointer text-sm text-primary hover:underline">View all</Link>
        </div>
            ...
            <tbody className="divide-y divide-border">
              {stats.recentAppointments.map((appointment) => (
                <tr key={appointment.id} className="hover:bg-secondary/30">
                  ...
                  <td className="whitespace-nowrap px-6 py-4 text-muted-foreground">{appointment.doctorName}</td>
                  <td className="whitespace-nowrap px-6 py-4 text-muted-foreground">{appointment.department}</td>
                  <td className="whitespace-nowrap px-6 py-4 text-muted-foreground">{appointment.date} at {appointment.time}</td>
                  <td className="whitespace-nowrap px-6 py-4">
                    <span className={`inline-flex rounded-full px-2.5 py-0.5 text-xs font-medium capitalize ${getStatusColor(appointment.status)}`}>
                      {appointment.status}
                    </span>
                  </td>
                </tr>
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-2">
        ...
        <div className="rounded-xl border border-border bg-card p-6">
          <h3 className="text-lg font-semibold text-foreground">Doctors by Department</h3>
        ...
        <div className="rounded-xl border border-border bg-card p-6">
          ...
          <div className="mt-4 space-y-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm font-medium text-foreground">{stats.pendingAppointments}</span>
            </div>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-foreground">{stats.completedAppointments}</span>
            </div>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-foreground">{stats.cancelledAppointments}</span>
            </div>
          </div>
        </div>
      </div>
