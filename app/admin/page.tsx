    ...
    <div>
      ...
      <div className="rounded-xl border border-border bg-card">
        <div className="flex items-center justify-between border-b border-border px-6 py-4">
          ...
          <Link href="/admin/appointments" className="cursor-pointer text-sm text-primary hover:underline">
            View all
          </Link>
        </div>
      ...
      <div className="mt-8 grid gap-4 md:grid-cols-2">
        ...
        <div className="rounded-xl border border-border bg-card p-6">
          ...
          <div className="mt-4 space-y-3">
            {Array.from(new Set(mockDoctors.map(d => d.department))).map((dept) => {
              const count = mockDoctors.filter(d => d.department === dept).length;
              return (
